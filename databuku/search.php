            ...
            <table>
                ...
                <?php
                    ...
                    if(isset($_POST['search'])){
                        ...
                        $sql = "SELECT * FROM data_buku WHERE CONCAT(Id_Buku, Judul, Genre, Pengarang, Penerbit, Stock, Status) LIKE'%$search%'";
                        ...
                        while($data = mysqli_fetch_array($query)){
                            echo"
                                ...
                                <td>$data[Status]</td>
                                <td>
                                    <a href=formedit.php?Id_Buku=".$data['Id_Buku']."><button class='action-button'>Edit</button></a> |
                                    <a href=deleteds.php?Id_Buku=".$data['Id_Buku']."><button class='action-button'>Delete</button></a>
                                </td>
                            </tr>
                        ";}
                    }else{
